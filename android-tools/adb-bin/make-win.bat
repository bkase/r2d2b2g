...
set files=adb.cpp adb_client.cpp commandline.cpp console.cpp file_sync_client.cpp services.cpp transport.cpp transport_local.cpp transport_usb.cpp usb_vendors.cpp utils.cpp exports.cpp usb_windows.cpp get_my_path_windows.cpp declare_array_lists.cpp sysdeps_win32.cpp ..\\libcutils\\list.c
