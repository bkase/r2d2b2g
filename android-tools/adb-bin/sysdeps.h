...
static __inline__ int  adb_thread_create_raw( adb_thread_t  *thread, adb_thread_func_t  func, void*  arg)
{
...
static __inline__ int  adb_thread_create_raw( adb_thread_t  *pthread, adb_thread_func_t  start, void*  arg )
{
    /*pthread_attr_t   attr;
